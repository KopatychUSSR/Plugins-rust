...
namespace Oxide.Plugins
{
    ...
    class MultiEvents : RustPlugin
    {
        ...
        void OnPlayerDie(BasePlayer player, HitInfo info)
        {
            ...
            {
                runner = new List<BasePlayer>(BasePlayer.activePlayerList).GetRandom();
                for (int i = 0; i < BasePlayer.activePlayerList.Count; i++)
            ...
            switch (Type)
            {
                case "all":
                    ...
                    container.Add(new CuiLabel
                    {
                        ...
                        Text = { Text = $"<b>{TopName}</b>",Font = "robotocondensed-regular.ttf", FontSize = 17, Align = TextAnchor.MiddleCenter }
                    }, Layer);
                    container.Add(new CuiPanel
                    {
                    ...
                    container.Add(new CuiLabel
                    {
                        ...
                        Text = { Text = !string.IsNullOrEmpty(description) ? description : "",Font = "robotocondensed-regular.ttf", FontSize = 16, Align = TextAnchor.MiddleLeft }
                    }, Layer, Layer + ".Text");
                ...
                case "refresh":
                    ...
                    container.Add(new CuiLabel
                    {
                        ...
                        Text = { Text = GetMessage("EVENT.Timer", player.UserIDString, string.Format("{0:0}", time - GrabCurrentTime())),Font = "robotocondensed-regular.ttf", FontSize = 12, Align = TextAnchor.MiddleCenter }
                    }, Layer, Layer + ".Timer");
                    container.Add(new CuiPanel
                    {
                    ...
                    if (list != null)
                    {
                        for (int i = 0; i < list.Count; i++)
                        {
                            ...
                            {
                                RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1", OffsetMin = "24 0", OffsetMax = "0 0" },
                                Text = { Text = $"<b>{check.Key.displayName}</b>",Font = "robotocondensed-regular.ttf", FontSize = 16, Align = TextAnchor.MiddleLeft }
                ...
                case "FoundationDrop_Timer":
                    ...
                    {
                        RectTransform = { AnchorMin = "0 0", AnchorMax = "1 0", OffsetMin = "0 0", OffsetMax = "0 20" },
                        Text = { Text = GetMessage("FOUNDROP.WaitTime", player.UserIDString, string.Format("{0:0}", time - GrabCurrentTime())),Font = "robotocondensed-regular.ttf", FontSize = 12, Align = TextAnchor.MiddleCenter }
                    }, Layer, Layer + ".Timer");
                    container.Add(new CuiPanel
                    {
                        RectTransform = { AnchorMin = "0 1", AnchorMax = "1 1", OffsetMin = "10 0", OffsetMax = "-10 1" },
                ...
                case "FoundationDrop.Upd":
                    ...
                    container.Add(new CuiLabel
                    {
                        ...
                        Text = { Text = GetMessage("FOUNDROP.BlockAndPlayers", player.UserIDString, cEvent.BlockList.SelectMany(p => p).Count().ToString(), cEvent.PlayerConnected.Count().ToString()),Font = "robotocondensed-regular.ttf", FontSize = 18, Align = TextAnchor.UpperLeft }
                    }, Layer, Layer + ".Text");
                    break;
                case "SpecialCargo":
                    CuiHelper.DestroyUi(player, Layer + ".SpecialCargo");
                    ...
                    {
                        RectTransform = { AnchorMin = "0 0", AnchorMax = "1 1" },
                        Text = { Text = GetMessage("SpecialCargo.Purpose", player.UserIDString, end_mission.displayPhrase.english, GetGridString(end_mission.transform.position)),Font = "robotocondensed-regular.ttf", FontSize = 15, Align = TextAnchor.MiddleCenter }
                    }, Layer + ".SpecialCargo");
                    break;
            }
            ...
            {
                {
                    new CuiButton
                    {
                        ...
                        Text = { FadeIn = 1f, Color = "1 1 1 1", Font = "robotocondensed-regular.ttf",FontSize = 18, Align = TextAnchor.MiddleCenter, Text = $"{message}" }
                    },
                    "Overlay",
                    Layer + Name
                }
        ...
        void Help_UI(BasePlayer player, int page)
        {
            ...
            container.Add(new CuiButton
            {
                ...
                Text = { Text = GetMessage("UI.Back", player.UserIDString), FontSize = 20, Align = TextAnchor.LowerLeft, Font = "robotocondensed-regular.ttf" }
            }, Layer + ".Help", Layer + ".Help.Pages.Back");
            container.Add(new CuiButton
            {
                RectTransform = { AnchorMin = "1 0", AnchorMax = "1 0", OffsetMin = "-120 10", OffsetMax = "-40 35" },
                Button = { Color = "0 0 0 0", Command = $"event page {page + 1}" },
                Text = { Text = GetMessage("UI.Next", player.UserIDString), FontSize = 20, Align = TextAnchor.LowerRight, Font = "robotocondensed-regular.ttf" }
            }, Layer + ".Help", Layer + ".Help.Pages.Next");
            container.Add(new CuiLabel
            {
                RectTransform = { AnchorMin = "0 1", AnchorMax = "1 1", OffsetMin = "40 -65", OffsetMax = "-40 0" },
                Text = { Text = GetMessage("UI.Name", player.UserIDString),Font = "robotocondensed-regular.ttf", FontSize = 38, Align = TextAnchor.MiddleCenter }
            ...
            container.Add(new CuiLabel
            {
                ...
                Text = { Text = GetMessage("UI." + list, player.UserIDString),Font = "robotocondensed-regular.ttf", Color = "0 0 0 1", FontSize = 26, Align = TextAnchor.MiddleCenter }
            ...
            container.Add(new CuiLabel
            {
                ...
                Text = { Text = GetMessage("UI.Description." + list, player.UserIDString),Font = "robotocondensed-regular.ttf", FontSize = 22, Align = TextAnchor.UpperLeft }
            }, Layer + ".Help", Layer + ".Help.Logo");
            if (player.IsAdmin || permission.UserHasPermission(player.UserIDString, config.perm_admin))
            {
                container.Add(new CuiButton
                {
                    ...
                    Text = { Text = GetMessage("UI.Random", player.UserIDString), FontSize = 20, Align = TextAnchor.LowerCenter, Color = "0.48 0.41 0.9 1", Font = "robotocondensed-regular.ttf" }
                ...
                container.Add(new CuiButton
                {
                    ...
                    Text = { Text = GetMessage("UI.Cancel", player.UserIDString), FontSize = 16, Align = TextAnchor.LowerCenter, Color = "1 0.01 0.24 1", Font = "robotocondensed-regular.ttf" }
                ...
                container.Add(new CuiButton
                {
                    ...
                    Text = { Text = GetMessage("UI.Start", player.UserIDString), FontSize = 16, Align = TextAnchor.LowerCenter, Color = "0 0.6 0 1", Font = "robotocondensed-regular.ttf" }
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                {"FOUNDROP.Naked", "<size=16>Clear inventory! The event can be reached only <color=#3286e0><b>COMPLETELY NAKED</b></color></size>" },
            ...
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                {"FOUNDROP.Naked", "<size=16>На мероприятие можно попасть только <color=#3286e0><b>ПОЛНОСТЬЮ ГОЛЫМ</b></color></size>" },
