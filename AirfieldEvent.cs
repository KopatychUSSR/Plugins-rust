...
{
    [Info("AirfieldEvent", "Fruster", "1.4.7")]
    ...
    class AirfieldEvent : CovalencePlugin
    {
        ...
        class ConfigData
        {
            ...
            [JsonProperty("Minimum drops amount(minimum number of cargo spawns after plane landing)")]
            public int dropsAmount = 2;
            [JsonProperty("Maximum drops amount(maximum number of cargo spawns after plane landing, maximum 10)")]
